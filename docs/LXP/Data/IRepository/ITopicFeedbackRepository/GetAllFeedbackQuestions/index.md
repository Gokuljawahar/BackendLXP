...
# ITopicFeedbackRepository\.GetAllFeedbackQuestions\(\) Method
...
```csharp
System.Collections.Generic.List<LXP.Common.ViewModels.TopicFeedbackQuestionViewModel.TopicFeedbackQuestionNoViewModel> GetAllFeedbackQuestions()
```
