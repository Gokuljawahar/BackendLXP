---
sidebar_label: AnyLearnerByEmailAndPassword
---

# IRepository\.AnyLearnerByEmailAndPassword\(String, String\) Method
...
```csharp
System.Threading.Tasks.Task<bool> AnyLearnerByEmailAndPassword(string Email, string Password)
```
