...
# ILearnerProgressRepository\.GetMaterialByTopic\(Guid, Guid\) Method

**Containing Type**: [ILearnerProgressRepository](../index.md)

**Assembly**: LXP\.Data\.dll

```csharp
System.Threading.Tasks.Task<System.Collections.Generic.List<LXP.Common.Entities.LearnerProgress>> GetMaterialByTopic(Guid topicId, Guid learnerId)
```
