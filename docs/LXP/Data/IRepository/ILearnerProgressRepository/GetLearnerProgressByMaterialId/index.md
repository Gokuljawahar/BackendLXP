...
# ILearnerProgressRepository\.GetLearnerProgressByMaterialId\(Guid, Guid\) Method
...
```csharp
System.Threading.Tasks.Task<LXP.Common.Entities.LearnerProgress> GetLearnerProgressByMaterialId(Guid learnerId, Guid materialId)
```
