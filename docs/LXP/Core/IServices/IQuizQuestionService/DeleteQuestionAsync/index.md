---
sidebar_label: DeleteQuestionAsync
---

# IQuizQuestionService\.DeleteQuestionAsync\(Guid\) Method
...
```csharp
System.Threading.Tasks.Task<bool> DeleteQuestionAsync(Guid quizQuestionId)
```
