...
# IQuizQuestionService\.AddQuestionAsync\(QuizQuestionViewModel, List&lt;QuestionOptionViewModel&gt;\) Method

**Containing Type**: [IQuizQuestionService](../index.md)

**Assembly**: LXP\.Core\.dll

```csharp
System.Threading.Tasks.Task<Guid> AddQuestionAsync(LXP.Common.ViewModels.QuizQuestionViewModel.QuizQuestionViewModel quizQuestion, System.Collections.Generic.List<LXP.Common.ViewModels.QuizQuestionViewModel.QuestionOptionViewModel> options)
```
