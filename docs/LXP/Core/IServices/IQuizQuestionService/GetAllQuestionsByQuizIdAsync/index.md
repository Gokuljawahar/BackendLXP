...
# IQuizQuestionService\.GetAllQuestionsByQuizIdAsync\(Guid\) Method
...
```csharp
System.Threading.Tasks.Task<System.Collections.Generic.List<QuizQuestionNoViewModel>> GetAllQuestionsByQuizIdAsync(Guid quizId)
```
