---
sidebar_label: StartQuizAttemptAsync
---

# QuizEngineService\.StartQuizAttemptAsync\(Guid, Guid\) Method
...
```csharp
public System.Threading.Tasks.Task<Guid> StartQuizAttemptAsync(Guid learnerId, Guid quizId)
```
...
* [IQuizEngineService.StartQuizAttemptAsync](../../../IServices/IQuizEngineService/StartQuizAttemptAsync/index.md)
