...
# CourseLevelController\.GetAllCourseLevel\(String\) Method

**Containing Type**: [CourseLevelController](../index.md)

**Assembly**: LXP\.Api\.dll

```csharp
[Microsoft.AspNetCore.Mvc.HttpGet("/lxp/course/courselevel/{id}")]
public System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.IActionResult> GetAllCourseLevel(string id)
```
