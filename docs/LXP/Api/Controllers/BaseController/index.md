...
**Namespace**: [LXP.Api.Controllers](../index.md)
...
[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [ControllerBase](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.controllerbase) &#x2192; BaseController

### Attributes

* [ApiControllerAttribute](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.apicontrollerattribute)
* [ControllerAttribute](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.controllerattribute) \(Inherited from [ControllerBase](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.controllerbase)\)
* [RouteAttribute](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.routeattribute)

### Derived

* [CategoryController](../CategoryController/index.md)
* [CourseController](../CourseController/index.md)
* [CourseFeedbackController](../CourseFeedbackController/index.md)
* [CourseLevelController](../CourseLevelController/index.md)
* [CourseTopicController](../CourseTopicController/index.md)
...
| [Created()](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.controllerbase.created) |  \(Inherited from [ControllerBase](https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.mvc.controllerbase)\) |
...
| [CreateFailureResponse(String, Int32)](CreateFailureResponse/index.md) | Creates a failure response with specified message and status code\. |
| [CreateInsertResponse(dynamic)](CreateInsertResponse/index.md) | Creates a response for successful data insertion with optional data\. |
| [CreateNoContentResponse(dynamic)](CreateNoContentResponse/index.md) | Creates a response for successful request with no content and optional data\. |
| [CreateSuccessResponse(dynamic)](CreateSuccessResponse/index.md) | Creates a success response with optional data\. |
| [CreateSuccessResponseForDelete(dynamic)](CreateSuccessResponseForDelete/index.md) | Creates a success response with optional data\. |
...
| [ValidateModel(Object)](ValidateModel/index.md) | Validates the given model and returns appropriate response if validation fails\. |
...
* [DashboardController](../DashboardController/index.md)
* [EnrollmentController](../EnrollmentController/index.md)
* [ExcelToJsonController](../ExcelToJsonController/index.md)
* [LearnerAttemptController](../LearnerAttemptController/index.md)
* [LearnerController](../LearnerController/index.md)
* [LearnerDashboardController](../LearnerDashboardController/index.md)
* [LearnerProgressController](../LearnerProgressController/index.md)
* [MaterialController](../MaterialController/index.md)
* [MaterialTypeController](../MaterialTypeController/index.md)
* [QuizController](../QuizController/index.md)
* [QuizFeedbackController](../QuizFeedbackController/index.md)
* [QuizQuestionsController](../QuizQuestionsController/index.md)
* [QuizReportController](../QuizReportController/index.md)
* [RegistrationController](../RegistrationController/index.md)
* [TopicFeedbackController](../TopicFeedbackController/index.md)
* [UpdatePasswordController](../UpdatePasswordController/index.md)
