---
sidebar_label: GetAllCourseDetailsByLearnerId
---

# CourseController\.GetAllCourseDetailsByLearnerId\(String\) Method
...
```csharp
[Microsoft.AspNetCore.Mvc.HttpGet("/lxp/view/Getallcoursebylearnerid/{learnerId}")]
public System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.IActionResult> GetAllCourseDetailsByLearnerId(string learnerId)
```
