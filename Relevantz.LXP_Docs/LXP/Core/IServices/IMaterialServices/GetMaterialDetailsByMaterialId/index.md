...
# IMaterialServices\.GetMaterialDetailsByMaterialId\(String\) Method
...
```csharp
System.Threading.Tasks.Task<LXP.Common.ViewModels.MaterialListViewModel> GetMaterialDetailsByMaterialId(string materialId)
```
