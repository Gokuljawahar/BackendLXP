...
```csharp
Guid AddFeedbackQuestion(LXP.Common.ViewModels.CourseFeedbackQuestionViewModel.CourseFeedbackQuestionViewModel courseFeedbackQuestion, System.Collections.Generic.List<LXP.Common.ViewModels.CourseFeedbackQuestionViewModel.CourseFeedbackQuestionsOptionViewModel> options)
```
